...
// 站点的appid （请勿修改）
global $_GPC, $_W;
$appid = $_W['hjkcms_global']['jdappid'];//'10000';

// 站点的appkey（请勿修改）
$appkey = $_W['hjkcms_global']['jdappkey'];//'a5837bcb270330430b5bd68b83dea8a4';
...
$clienturl=$this->createMobileUrl('index').'&';
...
$html = preg_replace('/<a(.+?)href="\/\?/','<a$1href="'.$clienturl.'',$html);
